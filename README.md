...
// simple autobahn app example : it is just an object containing few things
// that describe context/modes/session/user management logics.
var autobahnApp = {
	express: app,
	port:3000,
	loggedIn: loggedIn,
...
.use(autobahn.restful.map( YOUR_RESTFUL_MAP ))	// deep-restful map-to-services
